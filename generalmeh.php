...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Free Mehandi Designs for Indian Festivals</h2>

    <div class="separatorline"></div>

    <div class="main1">

        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 1</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 2</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 3</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general4.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 4</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general5.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 5</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general6.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Mehandi 6</div>
            </a>
        </div>
