...
<body>
    ...
    <!-- body part -->
    <div class="signscorpio">

        <img src="scorpio.avif" width="150px" height="150px" alt="capricorn"><br>
    </div>
    <div class="headersign">
        <b>
            <h1>SCORPIO SIGN HOROSCOPE</h1>
        </b>
    </div>
    <div class="body">
        ...
        <div class="scroll">
            <div class="info-1" style="display: block;">
                ...
                <p>
                    ...
                    ?>
                    <?php
                    $sql = "select scorpio from zodiacsign";
            ...
            <div class="info-2" style="display: none;">
                ...
                <p>
                    <?php
                    $sql = "select scorpio from weeklyprediction";
                    $result = mysqli_query($conn, $sql);
                    $record = mysqli_fetch_assoc($result);
                    echo $record['scorpio'];
                    ?>
            ...
            <div class="info-3" style="display: none;">
                ...
                <p>
                    <?php
                    $sql = "select scorpio from monthlyprediction";
                    $result = mysqli_query($conn, $sql);
                    $record = mysqli_fetch_assoc($result);
                    echo $record['scorpio'];
                    ?>
