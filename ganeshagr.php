...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Ganesha Chaturthi Greeting Cards</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="">
                ...
                <div class="blocktitle">Lord Ganesha Puja with Chatte</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\ganesha2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Ganesha Mahodara Incarnation
                    Om Ganeshay Namah</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\ganesha3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Ganesha Vighnaraja Incarnation
                    Om Ganeshay Namah</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\ganesha4.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Ganesha on Mushak Rath
                    Om Ganeshay Namah</div>
            </a>
        </div>
