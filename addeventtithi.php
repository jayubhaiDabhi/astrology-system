...
$sql = "INSERT INTO calendartithi ( `tithi` , `paksha` , `month` , `info` ) VALUES ('$tithi', '$paksha','$month', '$event');";
...
<body>
    <div class="wrapper">
        ...
        <input type="submit" value="add event" name="addevent"><br> -->
            ...
            <h1>Add Event Tithi</h1>

            <div class="input-box">
                <textarea placeholder="Add Tithi" name="tithi"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Paksha" name="paksha"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Month" name="month"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Event" name="event"></textarea>
            </div>
