...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center; margin-top:50px;">Bal Ganesha Miniature</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\ganesha\ganesha2.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\ganesha\ganesha4.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\ganesha\ganesha3.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\ganesha\ganesha1.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
