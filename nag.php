...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Nag Panchami Dot Rangoli Designs</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            ...
            <div class="blocktitle">Nag Panchami Rangoli 1</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\nag2.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Nag Panchami Rangoli 2</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\nag3.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Nag Panchami Rangoli 3</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\nag4.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Nag Panchami Rangoli 4</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\nag5.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Nag Panchami Rangoli 5</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\nag6.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Nag Panchami Rangoli 6</div>
        </div>
