...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center; margin-top:50px;">Bal Hanuman Miniature</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman1.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman2.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman3.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman4.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman5.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerkr dpratiogan">
                    <img src="img\hanuman\hanuman6.png" class="dpcontainerimg1">
                </div>
            </a>
        </div>
