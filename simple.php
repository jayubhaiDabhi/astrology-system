...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Simple Rangoli Designs for Hindu festivals</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple1.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 1</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple2.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 2</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple3.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 3</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple4.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 4</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple5.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 5</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple6.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 6</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple7.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 7</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple8.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 8</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\simple9.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Simple Rangoli 9</div>
        </div>
    </div>
