...
<head>
    ...
    <title>aquarius horoscope</title>
...
<body>
    ...
    <!-- body part -->
    <div class="signaquarius">

        <img src="aquarius.jpg" width="150px" height="150px" alt="aquarius"><br>
    </div>
    <div class="headersign">
        <b>
            <h1>AQUARIUS SIGN HOROSCOPE</h1>
        </b>
    </div>
    <div class="body">
        ...
        <div class="scroll">
            <div class="info-1" style="display: block;">
                ...
                <p>
                    <?php
                    $sql = "select aquarius from zodiacsign";
                    $result = mysqli_query($conn, $sql);
                    $record = mysqli_fetch_assoc($result);
                    echo $record['aquarius'];
                    ?>
            ...
            <div class="info-2" style="display: none;">
                ...
                <p>
                    <?php
                    $sql = "select aquarius from weeklyprediction";
                    $result = mysqli_query($conn, $sql);
                    $record = mysqli_fetch_assoc($result);
                    echo $record['aquarius'];
                    ?>
            ...
            <div class="info-3" style="display: none;">
                ...
                <p>
                    <?php
                    $sql = "select aquarius from monthlyprediction";
                    $result = mysqli_query($conn, $sql);
                    $record = mysqli_fetch_assoc($result);
                    echo $record['aquarius'];
                    ?>
