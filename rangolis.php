...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Rangoli Collection for Hindu Festivals</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <a href="diwali.php">
                ...
                <div class="blocktitle">Diwali Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="dot.php">
                ...
                <div class="blocktitle">Dot Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="ganesha.php">
                ...
                <div class="blocktitle">Ganesha Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="nag.php">
                <div class="dpcontainer dpratio">
                    <img src="img\rangoli\nag1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Nag Panchami Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="peacock.php">
                ...
                <div class="blocktitle">Peacock Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="ratham.php">
                <div class="dpcontainer dpratio">
                    <img src="img\rangoli\ratham1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Ratham Rangolis</div>
            </a>
        </div>

        <div class="block singleblock">
            <a href="sankranti.php">
                <div class="dpcontainer dpratio">
                    <img src="img\rangoli\sankranti1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Sankranti Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="shiva.php">
                ...
                <div class="blocktitle">Lord Shiva Rangolis</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="simple.php">
                ...
                <div class="blocktitle">Simple Rangolis</div>
            </a>
        </div>
