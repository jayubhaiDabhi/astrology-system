...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Rakhi Greeting Cards</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="">
                ...
                <div class="blocktitle">Raksha Bandhan Puja Thali</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rakhi2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Rakhi with Puja Thali</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rakhi3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Rakhi with Puja Samagri</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rakhi4.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Raksha Bandhan Raksha Potli</div>
            </a>
        </div>
