...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Greeting cards for Hindu festivals</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="diwaligr.php">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\diwali1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Diwali Greetings</div>
            </a>
        </div>

        <div class="greetingblock">
            <a href="ganeshagr.php">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\ganesha1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Ganesh Chaturthi</div>
            </a>
        </div>

        <div class="greetingblock">
            <a href="hanumangr.php">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\hanuman1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Hanuman Jayanti Greetings</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="rakhigr.php">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rakhi1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Rakhi Greetings</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="ramagr.php">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rama1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Rama Navami Greetings</div>
            </a>
        </div>
