...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Simple Mehandi Designs for Indian Festivals</h2>
    ...
    <div class="main1">
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 1</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 2</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 3</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple4.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 4</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple5.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 5</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple6.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Mehandi 6</div>
            </a>
        </div>
