...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Hanuman Jayanti Greeting Cards</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="">
                ...
                <div class="blocktitle">Hanuman Giving Blessings</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\hanuman2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Hanuman Flying with Mountain</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\hanuman3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Seat Made of Hanuman Tail</div>
            </a>
        </div>
