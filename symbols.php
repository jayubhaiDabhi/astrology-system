...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center; margin-top : 50px;">Hindu Symbols</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\kalash.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Kalash</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\leave.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Betal Leave</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\bell.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Golden Bell</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\pair.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Kalash Pair</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\flower.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Sunflower</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="">
                <div class="dpcontainerin dpratiogan">
                    <img src="img\symbols\deepak.png" class="dpcontainerimg1">
                </div>
                <div class="blocktitleg">Deepak</div>
            </a>
        </div>
