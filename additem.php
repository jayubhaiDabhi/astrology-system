...
$sql = "INSERT INTO additem ( `name` , `img` , `price` , `info` ) VALUES ('$name', '$img','$price', '$info');";
...
<body>
    <div class="wrapper">
        ...
        <input type="submit" value="add event" name="addevent"><br> -->
            ...
            <div class="input-box">
                <textarea placeholder="Add Item Name" name="name"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Item Image" name="img"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Item Price" name="price"></textarea>
            </div>
            <div class="input-box">
                <textarea placeholder="Add Item Info" name="info"></textarea>
            </div>
