...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Arabic Mehandi Designs for Indian Festivals</h2>
    ...
    <div class="main1">
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 1</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 2</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 3</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic4.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 4</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic5.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 5</div>
            </a>
        </div>
        ...
        <div class="mehandiblock">
            <a href="">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic6.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Mehandi 6</div>
            </a>
        </div>
