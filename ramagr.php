...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Rama Navami Greeting Cards</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="">
                ...
                <div class="blocktitle">Hanuman Massaging Rama's Feet</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rama2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Lord Rama with Bow-Arrow</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\rama3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Lord Rama Bow and Paduka</div>
            </a>
        </div>
