...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Ratham Rangoli Designs for Hindu Festivals</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            ...
            <div class="blocktitle">Ratham Rangoli 1</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\ratham2.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Ratham Rangoli 2</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\ratham3.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Ratham Rangoli 3</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\ratham4.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Ratham Rangoli 4</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\ratham5.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Ratham Rangoli 5</div>
        </div>

        <div class="block singleblock">
            <div class="dpcontainer dpratio">
                <img src="img\rangoli\ratham6.png" class="dpcontainerimg">
            </div>
            <div class="blocktitle">Ratham Rangoli 6</div>
        </div>
