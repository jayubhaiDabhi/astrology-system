...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Astrological Events</h2>
    ...
    <div class="main">
        ...
        <div class="block singleblock">
            <a href="combustion.php">
                <div class="blockimg">
                    <div class="dpcontainer dpratio">
                        <img src="img\combustion.png" class="dpcontainerimg">
                    </div>
                </div>

                <div class="blocktitle">Planets Combustion</div>
            </a>
        </div>

        <div class="block singleblock">
            <a href="retrograde.php">
                <div class="blockimg">
                    <div class="dpcontainer dpratio">
                        <img src="img\guru.png" class="dpcontainerimg">
                    </div>
                </div>

                <div class="blocktitle">Planets Retrograde</div>
            </a>
        </div>
        ...
        <div class="block singleblock">
            <a href="transit.php">
                <div class="blockimg">
                    <div class="dpcontainer dpratio">
                        <img src="img\transit.png" class="dpcontainerimg">
                    </div>
                </div>

                <div class="blocktitle">Planets Transit</div>
            </a>
        </div>
