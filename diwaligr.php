...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Diwali Greeting Cards</h2>
    ...
    <div class="main1">
        ...
        <div class="greetingblock">
            <a href="">
                ...
                <div class="blocktitle">Shri Kuber with wife Kauberi Happy Diwali</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\diwali2.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Lighting Deepmala during Diwali Happy Diwali</div>
            </a>
        </div>
        ...
        <div class="greetingblock">
            <a href="">
                <div class="dpcontainer1 dpratio1">
                    <img src="img\greeting\diwali3.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Lakshmi Ganesh Saraswati Pujan Happy Diwali</div>
            </a>
        </div>
