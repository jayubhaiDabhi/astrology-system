...
<body>
    ...
    <h2 class="dptitlecon" style="text-align:center;">Mehandi Collection for all Occasions</h2>
    ...
    <div class="main1">
        ...
        <div class="mehandiblock">
            <a href="africanmeh.php">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\african1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">African Designs</div>
            </a>
        </div>

        <div class="mehandiblock">
            <a href="arabicmeh.php">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\arabic1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Arabic Designs</div>
            </a>
        </div>

        <div class="mehandiblock">
            <a href="generalmeh.php">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\general1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">General Designs</div>
            </a>
        </div>

        <div class="mehandiblock">
            <a href="simplemeh.php">
                <div class="dpcontainer2 dpratio2">
                    <img src="img\mehandi\simple1.png" class="dpcontainerimg">
                </div>
                <div class="blocktitle">Simple Designs</div>
            </a>
        </div>
